...
const featuredProjects = [
  {
    ...
    description:
      "Une plateforme e-commerce complète avec panier, paiement Stripe, gestion des commandes et tableau de bord administrateur.",
  ...
  },
  {
    ...
    description:
      "Application SaaS de gestion de projets avec collaboration en temps réel, notifications et intégrations tierces.",
  ...
  },
  {
    ...
    description:
      "Site portfolio interactif avec animations, transitions fluides et design unique. Optimisé pour les performances.",
...
const otherProjects = [
  {
    title: "CLI Tool",
    description: "Outil en ligne de commande pour automatiser les tâches répétitives.",
    tech: ["Node.js", "Commander.js"],
    github: "https://github.com",
  },
  {
    title: "API REST",
    description: "API RESTful sécurisée avec authentification JWT.",
  ...
  {
    title: "Mobile App",
    description: "Application mobile de suivi d'habitudes.",
    tech: ["React Native", "Expo"],
    github: "https://github.com",
  },
  {
    title: "Design System",
    description: "Bibliothèque de composants UI réutilisables.",
    tech: ["React", "Storybook", "Tailwind"],
    github: "https://github.com",
  },
  {
    title: "Blog Platform",
    description: "Plateforme de blog avec CMS headless.",
    ...
    <section id="projects" className="py-24">
      ...
      <div className="space-y-16 mb-24">
        {featuredProjects.map((project, index) => (
          ...
          >
            {/* Image Placeholder */}
            <div className={`md:col-span-7 relative ${index % 2 === 1 ? "md:col-start-6 md:row-start-1" : ""}`}>
              <div className="aspect-video rounded-lg bg-card flex items-center justify-center text-6xl">
                {index === 0 ? "🛒" : index === 1 ? "📊" : "🎨"}
              </div>
            </div>
